...
- [x] **Version check**: marimo 0.23.9, notebooks downgraded from 0.23.13 → 0.23.9 (match installed version)
...
- [x] **Root-level tests**: 42 passed (72.97s) - tests/test_vindex_bindings.py
